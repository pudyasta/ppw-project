        ...
        <div class="flex flex-col flex-1 w-full overflow-y-auto">
            ...
            <main class="">
                <div class="py-10 mb-4 pb-10 px-8 mx-4 rounded-3xl bg-gray-100 border-4 border-[color:var(--violet)] min-h-[80vh] ">
                    <h3 class="text-gray-700 text-3xl font-medium py-6 ">Edit Barang</h3>
                    <?php
                    Flasher::flash();
                    ?>
                    <form autocomplete="off" action="<?php echo BASE_URL; ?>/dashboard/editbarangpost" method="post" enctype="multipart/form-data">
                        ...
                        <div class="md:flex gap-10">
                            <div class="flex flex-col gap-8 md:w-1/3">
                                ...
                                <div class="relative" data-te-input-wrapper-init>
                                    <input name="harga" type="number" class="peer  block min-h-[auto] w-full rounded border-0 bg-transparent  px-3 py-4 leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 peer-focus:text-primary data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-neutral-200 dark:placeholder:text-neutral-200 dark:peer-focus:text-primary [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0" id="exampleFormControlInputText" placeholder="Example label" value="<?php echo $data[0]['price']; ?>" required />
                                ...
                                <div class="relative" data-te-input-wrapper-init>
                                    <input name="stok" type="number" class="peer  block min-h-[auto] w-full rounded border-0 bg-transparent  px-3 py-4 leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 peer-focus:text-primary data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-neutral-200 dark:placeholder:text-neutral-200 dark:peer-focus:text-primary [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0" id="exampleFormControlInputText" placeholder="Example label" value="<?php echo $data[0]['stock']; ?>" required />
                                ...
                                <div>
                                    ...
                                    <input name="imagePast" type="text" value="<?php echo $data[0]['item_image']; ?>" hidden />
                                </div>
                            ...
                            <div class="md:w-2/3 md:mt-0 mt-8">
                                <select required name="category" data-te-select-init data-te-select-size="lg" data-te-class-form-outline="w-full relative py-2 flex items-center">
                                    <?php foreach ($data[1] as $d) : ?>
                                        <option value="<?php echo $d['category_id']; ?>" <?php echo $data[0]['category_id'] == $d['category_id'] ? 'selected' : ''; ?>>
                                ...
                                <div class="relative mb-3 w-full mt-8" data-te-input-wrapper-init>
                                    <textarea required name="deskripsi" class="peer block h-64 w-full rounded border-0 bg-transparent px-3 py-[0.32rem] leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-neutral-200 dark:placeholder:text-neutral-200 [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0" id="exampleFormControlTextarea1" rows="3" placeholder="Your message"><?php echo $data[0]['descriptions']; ?></textarea>
