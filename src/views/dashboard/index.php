            ...
            <main class="">
                <div class="grid mb-4 pb-10 px-8 mx-4 rounded-3xl bg-gray-100 border-4 border-[color:var(--violet)] min-h-[80vh] ">
                    <div class="grid grid-cols-12 gap-6">
                        <div class="flex flex-col grid-cols-12 col-span-12 gap-6 xxl:col-span-9">
                            <div class="col-span-12 mt-8">
                                <div class="flex items-center h-10 intro-y">
                                    <h3 class="text-gray-700 text-3xl font-medium pt-10 ">Dashboard</h3>
                            ...
                            <div class="col-span-12 flex justify-end">
                                <a href="<?php echo BASE_URL; ?>/dashboard/addPreOrder">

                                    <button class="px-6 py-3 bg-pink-600 rounded-xl text-white font-medium text-sm tracking-wide hover:bg-pink-500 ml-3">Tambah PO</button>
                                </a>
                            </div>
                            <div class="col-span-12 ">
                                <div class="grid gap-2 grid-cols-1 lg:grid-cols-1">
                                    <div class="bg-white p-4 shadow-lg rounded-lg">
                                        <h1 class="font-bold text-base mt-2">Daftar Masa Pre Order</h1>
                                        <div class="mt-4">
                                                            ...
                                                            <table class="min-w-full divide-y divide-gray-200">
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <th class="px-6 py-3 bg-gray-50 text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">
                                                                            <div class="flex cursor-pointer">
                                                                                <span class="mr-2">Tanggal Mulai</span>
                                                                            </div>
                                                                        </th>
                                                                        <th class="px-6 py-3 bg-gray-50 text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">
                                                                            <div class="flex cursor-pointer">
                                                                                <span class="mr-2">Tanggal Cut Off</span>
                                                                            </div>
                                                                        </th>
                                                                        <th class="px-6 py-3 bg-gray-50 text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">
                                                                            <div class="flex cursor-pointer">
                                                                ...
                                                                <tbody class="bg-white divide-y divide-gray-200">
                                                                    <?php foreach ($data as $d) : ?>
                                                                        <tr>
                                                                            ...
                                                                            <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5">
                                                                                <p><?php
                                                                                    $dateObj = date_create_from_format("Y-m-d", $d['start_date']);
                                                                                    $formattedDate = date_format($dateObj, "d-m-Y");
                                                                                    $monthNumber = date_format($dateObj, "m");
                                                                                    $monthName = date("F", strtotime("2000-$monthNumber-01"));
                                                                                    $formattedDate = str_replace(date("m", strtotime($d['start_date'])), $monthName, $formattedDate);
                                                                                    echo $formattedDate;
                                                                                    ?></p>
                                                                            </td>
                                                                            <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5">
                                                                            ...
                                                                            <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5">
                                                                                <div class="flex font-semibold text-<?php
                                                                                                                    if ($d['preorder_status'] == 'closed') {
                                                                                                                        echo 'red';
                                                                                                                    } else if ($d['preorder_status'] == 'on_going') {
                                                                                                                        echo 'green';
                                                                                                                    } else {
                                                                                                                        echo 'gray';
                                                                                                                    }
                                                                                                                    ?>-500">
                                                                                    <p><?php echo str_replace("_", " ", ucfirst($d['preorder_status'])); ?></p>
                                                                                </div>
                                                                            </td>
                                                                            <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5">
                                                                                <div class="flex space-x-10">
                                                                                    <a href="<?php echo BASE_URL; ?>/dashboard/auditorder/<?php echo $d['preorder_id']; ?>" class="text-orange-500 hover:text-orange-600">
                                                                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5  m-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
                                                                                        </svg>
                                                                                        <p>Audit Order</p>
                                                                                    </a>
                                                                                    <a href="<?php echo BASE_URL; ?>/dashboard/editpo/<?php echo $d['preorder_id']; ?>" class="text-blue-500 hover:text-blue-600">
                                                                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 m-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                                                                        </svg>
                                                                                        <p>Edit</p>
                                                                                    </a>
                                                                                    <form id="formx" action="<?php echo BASE_URL; ?>/dashboard/deletepreorder/" method="post">
                                                                                        <input name="id" type="text" class="hidden" value="<?php echo $d['preorder_id']; ?>">
