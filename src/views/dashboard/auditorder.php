                        ...
                        <div class="flex flex-col grid-cols-12 col-span-12 gap-6 xxl:col-span-9">
                            <div class="col-span-12 my-8 ">
                                <div class="flex items-center h-10 intro-y">
                                    <h3 class="text-gray-700 text-3xl font-medium pt-10 ">Audit Order</h3>
                                                                    ...
                                                                    <tr>
                                                                        <th class="px-6 py-3 bg-gray-50 text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">
                                                                            <div class="flex cursor-pointer">
                                                                                <span class="mr-2">nama customer</span>
                                                                            </div>
                                                                        </th>
                                                                        <th class="px-6 py-3 bg-gray-50 text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">
                                                                            <div class="flex cursor-pointer">
                                                                    ...
                                                                    <?php foreach ($data as $d) : ?>
                                                                        <tr>
                                                                            <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5">
                                                                                <p><?php echo $d['customer_name']; ?></p>

                                                                            </td>
                                                                            <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5">
                                                                                <p><?php echo $d['customer_email']; ?></p>
                                                                            </td>
                                                                            <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5">
                                                                                <img class="h-full   top-0 object-cover w-32" src="<?php echo BASE_URL . '/' . $d['payment_prove'] ?>" />

                                                                            </td>

                                                                            <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5">
                                                                                <div class="flex capitalize text-<?php
                                                                                                                    if ($d['status'] == 'pending') {
                                                                                                                        echo 'orange';
                                                                            ...
                                                                            <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5">
                                                                                <div class="flex space-x-10">
                                                                                    ...
                                                                                    <a href="<?php echo BASE_URL; ?>/dashboard/editpo/<?php echo $d['preorder_id']; ?>" class="text-green-500 hover:text-blue-600">
